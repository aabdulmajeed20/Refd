				...
				<div class="container">
					<div class="row align-items-center">	
						...
						<div class="col-lg-7 col-md-8">
							...
							<p class="lead">نص افتراضي لتعريف مختصر عن المنصة</p>		
						</div>
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="about-captione">
								...
								<h2>كلمة متخصرة لعنوان الشركة</h2>
								...
								<ul class="lists-3 mt-3">
									<li>لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم لتعرض على العميل </li>
									<li>ليتصور طريقه وضع النصوص بالتصاميم سواء كانت تصاميم مطبوعه</li>
									<li>بروشور او فلاير على سبيل المثال</li>
								</ul>
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-12 col-sm-12">
									<div class="yel098_7uw">
										...
										<div class="yel_7bcx">
											<h4>عنوان افتراضي</h4>
											<p>لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم لتعرض على العمي.</p>									
										</div>
									</div>
								</div>
					...
					<div class="row justify-content-center">
						<div class="col-lg-7 col-md-9">
							<div class="sec-heading">
								...
								<p>وعند موافقه العميل المبدئيه على التصميم يتم ازالة هذا النص من التصميم ويتم وضع النصوص النهائية .</p>
							</div>
						</div>
					</div>
					...
					<div class="row justify-content-center">
						<div class="col-lg-7 col-md-9">
							<div class="sec-heading">
								...
								<p>هنالك العديد من الأنواع المتوفرة لنصوص لوريم إيبسوم، ولكن الغالبية تم تعديلها بشكل ما عبر إدخال بعض النوادر أو الكلمات العشوائية إلى</p>
							</div>
						</div>
					</div>
