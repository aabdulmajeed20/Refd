...
Route::prefix('Charity')->name('charity.')->group(function() {
    ...
    Route::get('postProject', [
        'uses' => 'CharitiesController@postProject',
        'as' => 'postProject'
    ]);
    Route::get('messages', [
        'uses' => 'CharitiesController@messages',
        'as' => 'messages'
    ]);
    Route::get('logout', [
...
Route::prefix('Endowment')->name('endowment.')->group(function() {
    ...
    Route::get('projectDetails', [
        'uses' => 'EndowmentsController@projectDetails',
        'as' => 'projectDetails'
    ]);
    Route::get('logout', [
